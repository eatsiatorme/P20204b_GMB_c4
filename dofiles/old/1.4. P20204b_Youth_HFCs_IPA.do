...
ipacheckimport using "C:\Users\/`c(username)'\C4ED\P20204b_EUTF_GMB - Documents\02_Analysis\06_Field_Work_Reports\Midline\C3\HFC\04_checks\01_inputs\hfc_inputs2.xlsm"
...
if ${run_outliers} {
 cap ipacheckoutliers ${variable11}, id(${id}) ///
    enumerator(${enum}) ///
    submit(${date}) ///
