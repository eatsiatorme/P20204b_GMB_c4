/*
// This do-file: 
// Runs the ado-files for the IPA Checks sheet completed
// You should not edit this do-file unless necessary
...
ipacheckimport using "$data_quality/04_checks/01_inputs/hfc_inputs.xlsm"
